...
vector<bool> kidsWithCandies(vector<int>& candies, int extraCandies) {
	...
	//*max_element 这里的 * 是解引用操作符，用于获取 max_element 函数返回的迭代器指向的值
	vector<bool> ret;
	for (int i = 0; i < n; i++) {
...
int main() {
	...
	vector<bool> result1 = kidsWithCandies(candies1, extraCandies1);
	cout << "输出: ";
	...
	vector<bool> result2 = kidsWithCandies(candies2, extraCandies2);
	cout << "输出: ";
